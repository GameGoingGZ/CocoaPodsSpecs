...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://gitcode.com/harvey520/DDLLSDK"
  ...
  spec.vendored_frameworks = "DDLLSDK.framework"
  spec.public_header_files = "DDLLSDK.framework/Headers/*.h"
  ...
  spec.resource  = "DDLLSDK.bundle"
  # spec.resources = "Resources/*.png"
  # spec.resource_bundles = {
  #  "DDLLSDK.bundle" => ["DDLLSDK.momd/*.{mom,plist}","*.{plist}"]
  # }
